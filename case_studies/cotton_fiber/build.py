...
proc_cotton = o.Process(
    ...
    exchanges=[
        ...
        emission_exchange(co2, 0.8),
        emission_exchange(n2o, 0.015),
        emission_exchange(nh3, 0.010),
        resource_exchange(water, L, 8000.0),
    ],
)
...
entities = flows + processes + [gwp, ep, ap, pmfp, method] + list(unit_groups.values()) + [volume_group]
