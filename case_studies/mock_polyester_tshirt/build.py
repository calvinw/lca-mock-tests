...
# ---- Flows ----
oil = make_product_flow("Mock Crude oil", KG)
fiber = make_product_flow("Mock Polyester fiber", KG)
tshirt = make_product_flow("Mock T-shirt", UNIT)
...
# ---- Processes ----
proc_oil = o.Process(
    id=uid(), name="Mock Oil extraction", process_type=o.ProcessType.UNIT_PROCESS,
    location=GLO,
    exchanges=[
...
proc_fiber = o.Process(
    id=uid(), name="Mock Polyester fiber production", process_type=o.ProcessType.UNIT_PROCESS,
    location=GLO,
    exchanges=[
...
proc_tshirt = o.Process(
    id=uid(), name="Mock T-shirt assembly", process_type=o.ProcessType.UNIT_PROCESS,
    location=GLO,
    exchanges=[
